...
function SolarisPreLoader({viewBox}) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80%" height="80%"
			...
			<g>
				<animate id="curves" attributeName="opacity" from="1" to="0" begin="curve3.end" dur="1s" fill="freeze"/>
				...
				<path id="c2" className="st0" d="M164.93,864.23C135.02,836.09,29.84,730.36,9.79,557.08C4.75,513.49-3.83,388.54,69.36,258.35
					...
					<animate id="curve2" attributeName="stroke-dashoffset" from="2400" to="0" dur="2s" fill="freeze"/>
				</path>
				<path id="c3" className="st0" d="M610.04,815.37c-115.99,40.44-215.15,1.65-236.22-7.14c-13.73-5.73-149.67-65.11-192.19-216.56
					...
					<animate id="curve3" attributeName="stroke-dashoffset" from="2200" to="0" begin="curve2.end" dur="1s" fill="freeze"/>
				</path>
				<path id="c4" className="st0" d="M155.6,855.31c-2.83-2.73-22.24-21.59-40.82-44.75C39.09,716.24,18.5,613.21,14.13,589.11
					...
					<animate attributeName="stroke-dashoffset" from="3100" to="0" dur="2s" fill="freeze"/>
				</path>
			</g>
	</svg>
